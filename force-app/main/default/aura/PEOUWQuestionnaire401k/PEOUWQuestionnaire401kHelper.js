({ 
    clearOutFields : function(component, event, helper) {
        ...
        if(component.get('v.PEOChecklist.Does_company_offer_a_retirement_plan__c') != 'No')
        {
            ...
            relatedFieldList.push('no_retierment_plan_explanation__c');
        }
        ...
        if(component.get('v.PEOChecklist.Does_company_offer_a_retirement_plan__c') != 'Yes')
        {
            ...
            relatedFieldList.push('Who_is_your_retirement_plan_provider__c','retirment_plan_kind__c','total_asset_size_of_retierment_plan__c','peo_plan_utilized_if_peo_previously_used__c','request_for_changes_to_peo_plan_used__c');
        }
        if(component.get('v.PEOChecklist.Has_current_dental_carrier__c') != 'Yes')
        {
            ...
            relatedFieldList.push('Who_is_your_Current_Dental_Carrier__c');
        }
        if(component.get('v.PEOChecklist.Has_current_dental_carrier__c') == 'Yes')
        {
            component.set('v.PEOChecklist.Interested_in_dental__c', "");
            relatedFieldList.push('Interested_in_dental__c');
        }
        if(component.get('v.PEOChecklist.has_current_Vision_Carrier__c') != 'Yes')
        {
            ...
            relatedFieldList.push('Who_is_your_Current_Vision_Carrier__c');
        }
        if(component.get('v.PEOChecklist.has_current_Vision_Carrier__c') == 'Yes')
        {
            component.set('v.PEOChecklist.interested_in_Vision__c', "");
            relatedFieldList.push('interested_in_Vision__c');
        }
    ...
    saveProgress : function(component, event, helper) {
        return new Promise(function(resolve, reject) {
            ...
            if(iscommUser){
                ...
                relatedFieldList.push('Peo_401k_formStatus__c','Peo_401k_SubmissionTime__c');
                helper.relatedFieldChanges(component, event, helper,'PEO_Onboarding_Checklist__c',relatedFieldList);
            }
