({
    handleChange: function(cmp, e, helper) {
        try {
            ...
            if(fieldName == 'Percentage_of_residential_work__c' || fieldName == 'Percentage_of_commercial_work__c'){
                var total = parseInt(cmp.get('v.contractorIndustryRec.Percentage_of_residential_work__c')) + 
                    parseInt(cmp.get('v.contractorIndustryRec.Percentage_of_commercial_work__c'));
                if(total != 100){
            ...
            if (fieldValue && fieldValue.length) {
                let recordId = cmp.get('v.contractorIndustryRec.Id');
    ...
    doInit: function(cmp, e, helper) {
        //cmp.set('v.showSpecific',cmp.get('v.naicsInfo').includes('561720'));
    },
