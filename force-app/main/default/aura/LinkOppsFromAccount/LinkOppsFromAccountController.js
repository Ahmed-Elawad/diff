({
    ...
    setUpForAccount : function(component, event, helper) {  
  	console.log("LM LOAD FROM ACCOUNT");
  	component.set('v.loaded', false); 
        ...
        var myAcctId = component.get("v.accountId");
        helper.getData(component, event, 'getAcctOpps', 'Opportunities', myAcctId);
        },
    ...
    handleSelected: function (component, event, helper) {
        ...
        //if 2 are selected, display success message, reload Account page, process opps
         else{
             component.set('v.loaded', false);
             component.set('v.error', false);
