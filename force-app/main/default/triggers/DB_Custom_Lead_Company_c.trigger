...
*/
trigger DB_Custom_Lead_Company_c on Lead_Company__c ( before delete, after insert, after update, after undelete )
{
    /*
    try
    {
    ...
    {
        CRMfusionDBR101.DB_TriggerHandler.handleTriggerException( ex, 'DB_Custom_Lead_Company_c' );
    }
    */
}