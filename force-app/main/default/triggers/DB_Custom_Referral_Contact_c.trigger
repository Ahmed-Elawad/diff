...
*/
trigger DB_Custom_Referral_Contact_c on Referral_Contact__c ( before delete, after insert, after update, after undelete )
{
    /*
    try
    {
    ...
    {
        CRMfusionDBR101.DB_TriggerHandler.handleTriggerException( ex, 'DB_Custom_Referral_Contact_c' );
    }
    */
}